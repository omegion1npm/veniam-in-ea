...
__Motto of `@omegion1npm/veniam-in-ea` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@omegion1npm/veniam-in-ea@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@omegion1npm/veniam-in-ea`.
...
[npm-url]: https://www.npmjs.com/package/@omegion1npm/veniam-in-ea
[npm-badge]: https://img.shields.io/npm/v/@omegion1npm/veniam-in-ea.svg
[travis-url]: https://travis-ci.org/streamich/@omegion1npm/veniam-in-ea
[travis-badge]: https://travis-ci.org/streamich/@omegion1npm/veniam-in-ea.svg?branch=master
